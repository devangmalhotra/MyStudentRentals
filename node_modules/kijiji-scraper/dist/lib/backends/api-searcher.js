...
var APISearcher = /** @class */ (function () {
    ...
    APISearcher.prototype.getPageResults = function (params, pageNum) {
        var url = "".concat(API_SEARCH_ENDPOINT, "?").concat(querystring_1.default.stringify(__assign(__assign({}, params), { page: pageNum - 1, size: 20 // Results per page, just like the app
         })));
        // Search Kijiji
