...
function parseResultsHTML(html) {
    ...
    var paginationInfo = (_d = Object.values(parsedResultJson.ROOT_QUERY || {}).find(function (value) {
    ...
    })) === null || _d === void 0 ? void 0 : _d.pagination;
    if (paginationInfo === undefined) {
        throw new Error("Pagination information could not be found. ".concat(constants_1.POSSIBLE_BAD_MARKUP));
    }
    ...
    try {
        for (var filteredAds_1 = __values(filteredAds), filteredAds_1_1 = filteredAds_1.next(); !filteredAds_1_1.done; filteredAds_1_1 = filteredAds_1.next()) {
            ...
            adResults.push(new ad_1.Ad(ad.url, info));
        }
    }
